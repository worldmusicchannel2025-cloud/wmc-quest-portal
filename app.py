...
def get_gemini_response(prompt, api_key):
    # WICHTIG: Wir nutzen jetzt gemini-1.5-flash (Das moderne Modell für neue Accounts)
...
# Header Layout: Text Links, Bild Rechts (3:1 Verhältnis)
